...
<div class = "wrapper">
    <login-main>
        <form id = "login-form" action="<?php echo e(url('login')); ?>" method="post"> <?php echo e(csrf_field()); ?>
            ...
            <div id = "login-form-body">
                ...
                <div id = "login-inputs">
                    ...
                    <div id = "login-form-button">
                        <button id = "login-button" type="submit">Prisijungti</button>
                    </div>
                </div>
            </div>
        </form>
...
<?php /**PATH C:\xampp\htdocs\Bilietai2\resources\views/admin_login.blade.php ENDPATH**/ ?>
