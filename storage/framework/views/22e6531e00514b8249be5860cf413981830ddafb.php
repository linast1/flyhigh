...
<div class = "wrapper">
    <login-main>
        ...
        <?php endif; ?>
        <form class = "update-form" method="post" action="<?php echo e(url('confirmPurchase')); ?>"> <?php echo e(csrf_field()); ?>
            ...
            <div class = "expanded-form-content">
                ...
                <div class = "expanded-form-body">
                    <div class = "expanded-inputs">
                        ...
                        <input id = "expanded-firm" type = "text" autocomplete="off" name="owner_name" value="<?php echo e($ownername); ?>">
                        <label class = "expanded-label">Savininko pavardė:</label>
                        <input id = "expanded-firm" type = "text" autocomplete="off" name="owner_surname" value="<?php echo e($ownersurname); ?>">
                        ...
                        <div class="expanded-selects">
                            ...
                            <select id = "expanded-select-flight" name="fk_flight">
                                <?php $__currentLoopData = $selectedFlight; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flightsData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option class = "expanded-option" value="<?php echo e($flightsData->getKey()); ?>"><?php echo e($flightsData->id); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\Bilietai2\resources\views/searchTickets.blade.php ENDPATH**/ ?>